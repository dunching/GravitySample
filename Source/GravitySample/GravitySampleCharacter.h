...
#include "GravitySampleCharacter.generated.h"

class UNavigationPath;

UCLASS(config = Game)
class AGravitySampleCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	AGravitySampleCharacter(const FObjectInitializer& ObjectInitializer);
